...
toc: true
toc_sticky: true
title: Welcome to my Unity portfolio
...
[put gist here] AI based on state machine responds to player's actions and moves AI agents across a navmesh. 
<video loop="loop" width="100%" height="auto" autoplay loop muted controls>
  <source src="/assets/occluded_models.webm" type="video/webm">
</video>
Occluded models silhouettes Models silhouettes of occluded objects made with Universal Render Pipeline features.

# Retro FPS shooter - Current project
<video loop="loop" width="100%" height="auto" autoplay loop muted controls>
...
pring based weapon aiming. Weapon moves just like a spring responding to a change. 
...
[GitHub Repository](https://github.com/redmorr/navmesh-agent-simulation)
asdasdasdasdasd
...
Vignette pulse with DOTween . Tweeining engine smoothly animates vignette on being hit.
